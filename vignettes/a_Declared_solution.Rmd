...
because activating the argument `na.rm`{.R} will return the correct result, anyways.
...
of `TRUE`{.R} would obscure such problems, the mean being calculated irrespective of
