...
The base factors provide no possibility to assign specific values for the specific
categories, and most importantly they do not differentiate between valid values
and (declared) missing values. To make the functionality consistent with the base
...
The base factors store the categories using numeric values, and this is also
the most often scenario for the declared objects. But this is not at all
mandatory, as the declared objects are also able to ingest character objects:
