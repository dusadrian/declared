...
#> Error in (function (classes, fdef, mtable) : unable to find an inherited method for function 'labels<-' for signature '"declared", "numeric"'
x2
#> <declared<numeric>[7]>
#> [1]       1       2       3       4       5 NA(-91) NA(-91)
#> Missing values: -91
...
#>  [1]    b     c  NA(z)    b  NA(z) NA(z)    b     a     c  NA(z) NA(z)    b     b     c     b     c
#> [17]    b     b     a  NA(z)
#> Missing values: z
#>
#> Labels:
