...
test_that("tests have the same output", {
  ...
  # expect_snapshot(dfd)
  # expect_snapshot(as.haven(dfd))
  # expect_snapshot(as.haven(dfd, interactive = TRUE))
  # expect_snapshot(as.haven(dfd, only_declared = FALSE))
  # expect_snapshot(as.haven(dfd, only_declared = FALSE, interactive = TRUE))
})
